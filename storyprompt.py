...
class buildPrompt: 
    ...
    def generateName(self): 
        ...
        return name
    def contentPrompt(self, name, theme):
        return [f"""Create a unique, short 5-page book for children aged 4-5 years old. The story should be in this theme: {theme}. The main character should be named: {name}. Each page should follow this format:
